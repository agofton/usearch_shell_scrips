...
usearch9.2 -unoise2 all_samples_SF_DR.fasta -zotus unoise.fasta -tabbedout unoise_tab.txt 

usearch9.2 -usearch_global all_samples_SF.fasta -db unoise.fasta -strand both -id 0.97 -otutabout unoise_tab.txt -biomout unoise_otu_biom.biom
